...
(function (plugin, core, scene) {
    ...
    var meshColors = {
        '_Femur': '#FF4444',    // Red (Femur - thigh bone)
        '_Tibia': '#4444FF',    // Blue (Tibia - shin bone)
        '_Fibula': '#44FF44',   // Green (Fibula - smaller leg bone)
        '_Patella': '#FFAA00',  // Orange (Patella - kneecap)
        'default': '#A0A0A0'    // Gray
    };
